...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/flat-moon-1da1)
...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/flat-moon-1da1#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/flat-moon-1da1
```

A live public deployment of this template is available at [https://flat-moon-1da1.templates.workers.dev](https://flat-moon-1da1.templates.workers.dev)
